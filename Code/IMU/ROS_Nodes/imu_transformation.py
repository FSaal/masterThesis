...
class ImuTransform():
    ...
    def pitch_car(self):
        ...
        vel_x_car_filt = self.odom_filt_class.moving_average(vel_x_car, 15)
        acc_x_imu_filt = self.imu_filt_class.moving_average(self.acc_x_imu, 150)
        ...
        # # Debug part
        array = [self.acc_x_imu, acc_x_imu_filt, vel_x_car, vel_x_car_filt, acc_x_car, acc_x_car_filt,
                car_angle, car_angle_filt, self.vel_y_imu]
