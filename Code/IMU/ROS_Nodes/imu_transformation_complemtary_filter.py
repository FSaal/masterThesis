...
class ImuTransform():
    ...
    def __init__(self):
        ...
        self.lin_acc = []           # List used for calibration
        self.g_car = [0, 0, 1]      # g vector in car frame
        self.rec_win_g = 100        # Recording length g vector [s/100]
        self.rec_win_fwd = 200      # Recording length forward acceleration [s/100]
        self.f_imu = 100            # [Hz]
        self.f_odom = 100           # [Hz]
        self.wheelbase = 2.631      # eGolf wheelbase [m]
        self.vel_x_car_old = 0
        self.vel_x_car_filt_old = 0
        self.angle_est = 0

        # Moving Average Filter
        self.imu_filt_class = FilterClass()
        self.odom_filt_class = FilterClass()
        self.win_len = 50           # Window length: Delay of win_len/200 s
