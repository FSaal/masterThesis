...
\usepackage{caption}			% Needed for caption in subfigures
\usepackage{fancyhdr}			% Customize header and footers
\usepackage{float}				% Floating figures / tables
\usepackage[symbols,acronyms,abbreviations,automake]{glossaries-extra}	% Allows for definition of acronyms and stuff
