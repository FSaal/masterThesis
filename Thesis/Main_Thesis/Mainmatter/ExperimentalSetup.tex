...
The specifications of each \gls{imu} can be read in table \ref{tab:imu_datasheets}.
...
\iquest{i is natural number in range 0 to n, how to write?}
...
\iimprov{Text is bad e.g. "hacked" and table needs more rows or should be omitted}
\begin{table}[htbp]
	\centering
	\caption{Some params}
