...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        ...
        \label{fig:imu_zed}
    \end{subfigure}
    \caption[\glsentryplural{imu} used in the experiment]{The two \glspl{imu} which will be used for the recordings. The Stereolabs ZED 2i camera has an integrated \gls{imu}.}
    \label{fig:imus_used}
\end{figure}
...
\begin{table}[ht]
    \centering
    \caption[Comparison of the two used \glsentryplural{imu}]{Comparison of the two used \glsentryplural{imu}~\cite{Withrobot2017, Stereolabs2019}.}
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption[\glsentryplural{lidar} used in the experiment]{The two \glsentryplural{lidar} which will be used for the recordings.}
...
\begin{table}[ht]
    \centering
    \caption[Comparison of the two used \glsentryplural{lidar}]{Comparison of the two used \acrshort{lidar}s~\cite{RoboSense2020, Velodyne2018}.}
...
\begin{figure}[htb]
    ...
    \caption[\acrshort{lidar} placement on the car]{Calculation of the best mounting angle of the \acrshort{lidar} on the car. The used variables are described in \cref{tab:lidar_mount}.}
...
\begin{table}[htb]
    \centering
    \caption[Variables for the calculation of the \glsentryshort{lidar} mounting angle]{Variables used to calculate the optimal mounting angle of the \glsentryshort{lidar}.}
...
\begin{figure}[htb]
    \centering
    \input{Graphics/TikZ/eGolf_annotation.tex}
