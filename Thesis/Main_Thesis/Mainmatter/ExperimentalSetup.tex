...
\begin{figure}[htb]
	...
	\begin{subfigure}[b]{0.4\textwidth}
		...
		\label{fig:imu_zed}
	\end{subfigure}
	\caption{The two \glspl{imu} which will be used for the recordings. The Stereolabs ZED 2i camera has an integrated \gls{imu}.}
	\label{fig:imus_used}
\end{figure}
...
\iquest{PLA I think? How technical should I go?}
...
\missingfigure{Picture of eGolf with full sensor setup}
...
But due to the registration of the car as a \todo{test car?}, the car was not allowed to drive on public roads.
Hence, only the ramps inside the garage which the car currently resides could be used.
...
\begin{figure}[htb]
	...
	\begin{subfigure}{.24\linewidth}
		...
		\caption{}
	\end{subfigure}
	\caption{On the ramps A, B and C the car will be driven up. On the ramp D as well as also on the ramp A the car will be driven down.}
	\label{fig:all_ramps}
\end{figure}
\begin{table}[htb]
	\centering
