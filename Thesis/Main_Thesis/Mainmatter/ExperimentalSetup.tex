...
\itodo{Also add ZED 2i \gls{imu} and compare (probably table similar to \gls{lidar})}
...
\begin{figure}[htb]
	...
	\begin{subfigure}{0.3\textwidth}
		...
		\caption{Velodyne Ultra puck \cite{Rev}}
...
\end{figure}
\itodo{\gls{imu} placement not really important, should just be static}
...
\[ c = h - \frac{z}{\tan \alpha} \]
\itodo{\gls{lidar} pitch angle at which most point hit area before ramp can be calculated, explaination here using sketch \ref{fig:tikz_lidar_mount}}
