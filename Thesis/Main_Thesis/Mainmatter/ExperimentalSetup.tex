...
\begin{table}[htb]
    ...
    \begin{tabular}[t]{cccc}
        ...
        \midrule
        A             & \SI{7.2}{}                    & \SI{3.94}{}                  & \SI{11.97}{}                  \\
        B             & \SI{6.5}{}                    & \SI{3.96}{}                  & \SI{14.15}{}???               \\
        C             & \SI{7.4}{}                    & \SI{3.90}{}                  & \SI{11.85}{}                  \\
        D             & \SI{0}{}                      & \SI{0}{}                     & \SI{11.89}{}                  \\
        \bottomrule
    \end{tabular}
\end{table}
\itodo{Measure ramp D and check lengths again}
\iquest{What about ramp E (only used for cam)?}