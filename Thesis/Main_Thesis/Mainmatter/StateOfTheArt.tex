...
A method which does not rely on \gls{gps}, but only on accelerometers and wheel odometers instead is described in ref.~\cite{Nilsson2012} and~\cite{Palella2016}.
