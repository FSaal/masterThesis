...
It is important that both the \gls{imu} and odometer measurements are synchronized in time, otherwise the correct estimation can not be guaranteed.
...
\begin{equation}
	...
	= \arcsin\left(\frac{\vb{a}_\mathrm{x} - \dv{t}}{g}\right)
\end{equation}
\iimprov{Text is bad}
