...
\subsubsection{Linear acceleration only}
...
\end{figure}
\subsubsection{Angular velocity only}
...
\itodo{Remove time continuous all together? Or move in background chapter}
...
\subsection{\glsentryshort{imu} and Odometer}
\iimprov{Probably move this to the \glsentryshort{imu} section}
