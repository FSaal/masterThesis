...
\begin{align}
	...
	\label{eq:filter_f0}
\end{align}
The time constant $\tau$ determines at which relative duration of signal the filter will act on.
...
\iimprov{Check equations and improve structure, sort and add citations}
