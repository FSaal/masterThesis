...
\iimprov{Remove ez vector stuff}
...
\end{equation}
and the rotation angle with \todo{check second val in angle}
\begin{equation}
...
\iquest{Should this be an own section?}
...
\iimprov{More text and better explaination, also add cites}
