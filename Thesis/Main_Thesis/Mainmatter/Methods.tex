...
As seen in \cref{eq:ang_from_gyro}, $\theta_\mathrm{gyr}$ is calculated by integrating the angular velocity $\boldsymbol{\omega} $ measured by the gyroscope.
...
\itodo{Explain a bit more what grid search is.}
...
The tested values and the resulting scores will be presented in \cref{sec:eval_camera}
