...
\begin{figure}[htb]
    ...
    \caption[Microstructure of a \acrshort{mems} accelerometer]{The microstructure of a \acrshort{mems} accelerometer during an acceleration. The proof mass is suspended and moves delayed, in relation to the outer case and fixed capacitors plates, due to its inertia. The acceleration can be calculated from the change in capacity.}
