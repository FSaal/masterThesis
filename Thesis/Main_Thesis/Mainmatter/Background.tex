...
They can be rotated on up to two axes, but because the laser cannot be rotated a horizontal view of \SI{360}{\degree} is not possible \todo{fact check, might have understood it wrong}.
...
An odometer measures the wheel speeds.
One option is using induktive drehzahlsensoren, which is based on the induktionsgesetzt.
