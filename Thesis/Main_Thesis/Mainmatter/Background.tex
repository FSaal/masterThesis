...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.52\linewidth]{stable_platform_imu}
    \caption[Setup of a stable platform \acrshort{imu}]{Setup of a stable platform \acrshort{imu}~\cite{Woodman2007}. The platform always stays in alignment with the reference frame due to the gimbals.}
...
\begin{figure}[htb]
    ...
    \caption[Microstructure of a \acrshort{mems} accelerometer]{The microstructure of a \acrshort{mems} accelerometer. The proof mass is suspended and moves delayed, in relation to the outer case and fixed capacitors plates, due to its inertia. The acceleration can be calculated from the change in capacity.}
    \label{fig:mems_accelerometer}
\end{figure}
A mass (gray) is suspended by springs along one axis and if an acceleration along this axis occurs, the mass moves in the opposite direction due to Newton's second law.
...
While mechanical spinning systems are very precise and offer a great \gls{fov}, they are bulky, need a lot of power and are expensive~\cite{Fujii2005}.\par
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.6\linewidth]{wheel_speed_sensor_active.pdf}
...
The working principle is shown in \cref{fig:rcnn}.\par
\begin{figure}[htb]
    \centering
    \includegraphics[width=.75\linewidth]{rcnn.png}
