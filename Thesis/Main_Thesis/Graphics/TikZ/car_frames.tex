...
\begin{tikzpicture}[scale=1.5]
    ...
    \begin{scope}[rotate=-10]
        ...
        % Coordinate frames
        \draw[thick,->, red] (ml) -- ++(0.7,0,0) node[anchor=north east]{$x$};
        \draw[thick,->, black!35!green] (ml) -- ++(0,0,-0.7) node[anchor=west]{$y$};
        \draw[thick,->, blue] (ml) -- ++(0,0.7,0) node[anchor=south]{$z$};
    \end{scope}
\end{tikzpicture}
\end{document}